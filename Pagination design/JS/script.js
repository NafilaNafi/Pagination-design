...
req.onload = function () {
  try {
    ...
    function prevBtn() {
      ...
      pagenumber.insertAdjacentElement("afterbegin", btn);
      btn.innerText = "Prev";
    ...
    function nextBtn() {
      ...
      btn.innerText = "Next";
      pagenumber.insertAdjacentElement("beforeend", btn);
      btn.addEventListener("click", () => {
        current_page = +document.querySelector(".active").innerText;
    ...
    function firstLastBtn() {
      ...
      pagenumber.insertAdjacentElement("afterbegin", first_btn);
      let last_btn = document.createElement("button");
      last_btn.innerText = "Last";
      pagenumber.insertAdjacentElement("beforeend", last_btn);
    ...
    displayList(data, list, rows, current_page);
    setPagination(data, pagenumber, rows);
  } catch (err) {
    console.log(err);
  }
};
